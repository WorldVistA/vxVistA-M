...
X9 S DVBJ2=1
 Q
10 D:$D(DG)>9 F^DIE17,DE S DQ=10,DW=".11;1",DV="F",DU="",DLB="STREET ADDRESS [LINE 1]",DIFLD=.111
 S DE(DW)="C10^DVBHCE7",DE(DW,"INDEX")=1
 G RE
...
X10 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>35!($L(X)<3) X
 ...
 Q
 ;
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW=".11;2",DV="F",DU="",DLB="STREET ADDRESS [LINE 2]",DIFLD=.112
...
X11 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>30!($L(X)<3) X D:$D(X) UP^DGHELP
 ...
 Q
 ;
12 D:$D(DG)>9 F^DIE17,DE S DQ=12,DW=".11;3",DV="F",DU="",DLB="STREET ADDRESS [LINE 3]",DIFLD=.113
 S DE(DW)="C12^DVBHCE7",DE(DW,"INDEX")=1
 G RE
...
X12 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>30!($L(X)<3) X
 ...
 Q
 ;
13 D:$D(DG)>9 F^DIE17,DE S DQ=13,DW=".11;4",DV="F",DU="",DLB="CITY",DIFLD=.114
 S DE(DW)="C13^DVBHCE7",DE(DW,"INDEX")=1
 G RE
...
X13 K:$L(X)>15!($L(X)<2) X
 ...
 Q
 ;
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW=".11;5",DV="*P5'",DU="",DLB="STATE",DIFLD=.115
 S DE(DW)="C14^DVBHCE7",DE(DW,"INDEX")=1
 S DU="DIC(5,"
 G RE
...
X14 S DIC("S")="I $P(^DIC(5,Y,0),U,6)=1" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
15 D:$D(DG)>9 F^DIE17,DE S DQ=15,DW=".11;12",DV="FXO",DU="",DLB="ZIP+4",DIFLD=.1112
 S DQ(15,2)="S Y(0)=Y D ZIPOUT^VAFADDR"
 S DE(DW)="C15^DVBHCE7",DE(DW,"INDEX")=1
 G RE
...
X15 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>20!($L(X)<5) X I $D(X) D ZIPIN^VAFADDR
 ...
 Q
 ;
16 D:$D(DG)>9 F^DIE17 G ^DVBHCE14
