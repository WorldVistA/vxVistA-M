...
X1 S:IBDR20'["11" Y="@12"
 Q
2 S DW="0;3",DV="RDXO",DU="",DLB="DATE OF BIRTH",DIFLD=.03
...
5 D:$D(DG)>9 F^DIE17,DE S DQ=5,D=0 K DE(1) ;1
 S DIFLD=1,DGO="^IBXS12",DC="3^2.01^.01^",DV="2.01MF",DW="0;1",DOW="ALIAS",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
...
X7 S:IBDR20'["13" Y="@14"
 Q
8 S DW="0;2",DV="RS",DU="",DLB="SEX",DIFLD=.02
...
X16 S:$$EDADDR^IBCSCE(+$G(DFN)) Y="@155"
 Q
17 D:$D(DG)>9 F^DIE17,DE S DQ=17,DW=".11;1",DV="F",DU="",DLB="STREET ADDRESS [LINE 1]",DIFLD=.111
...
X18 S:X="" Y=.114
 Q
19 D:$D(DG)>9 F^DIE17,DE S DQ=19,DW=".11;2",DV="F",DU="",DLB="STREET ADDRESS [LINE 2]",DIFLD=.112
...
X20 S:X="" Y=.114
 Q
21 D:$D(DG)>9 F^DIE17,DE S DQ=21,DW=".11;3",DV="F",DU="",DLB="STREET ADDRESS [LINE 3]",DIFLD=.113
