IBXSAH ; GENERATED FROM 'IB SCREEN10H' INPUT TEMPLATE(#2134), FILE 399;01/08/16
 D DE G BEGIN
...
BEGIN S DNM="IBXSAH",DQ=1
 ...
 M DIEZAR=^DIE(2134,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2134,U="^"
