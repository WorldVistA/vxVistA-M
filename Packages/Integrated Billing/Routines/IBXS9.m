IBXS9 ; GENERATED FROM 'IB SCREEN9' INPUT TEMPLATE(#2135), FILE 399;01/08/16
 D DE G BEGIN
...
BEGIN S DNM="IBXS9",DQ=1
 ...
 M DIEZAR=^DIE(2135,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2135,U="^"
