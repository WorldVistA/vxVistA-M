IBXSA2 ; GENERATED FROM 'IB SCREEN102' INPUT TEMPLATE(#2133), FILE 399;01/08/16
 D DE G BEGIN
...
BEGIN S DNM="IBXSA2",DQ=1
 ...
 M DIEZAR=^DIE(2133,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2133,U="^"
