PSORENW1 ;BIR/DSD - Renew Main Driver Continuation ;03/29/93
 ;;7.0;OUTPATIENT PHARMACY;**20,37,51,46,71,117,157,143,219,239,225**;DEC 1997;Build 5
...
START ;
 ...
 ;DSS/AMC - BEGIN MODS If C2-5 and PAR enabled, get Prescription Pad #
 I $G(^%ZOSF("ZVX"))["VX" D
 .S:$$VXRX^VFDPSOU1 PSORENW("PRESCRIPTION PAD #")=$S($G(PSORENW("PRESCRIPTION PAD #"))]"":PSORENW("PRESCRIPTION PAD #"),1:$P($G(^PSRX(PSORENW("OIRXN"),21600)),U,2))
 ;DSS/AMC - END MODS
