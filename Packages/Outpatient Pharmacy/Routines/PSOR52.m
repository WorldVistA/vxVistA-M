PSOR52 ;IHS/DSD/JCM - Files refill entries in prescription file ;03/10/93
 ;;7.0;OUTPATIENT PHARMACY;**10,22,27,181,148,201,260,281,358,385,408**;DEC 1997;Build 29
...
INIT ;
 ...
 ;DSS/SMH/SMP - BEGIN MOD
 S PSOX("DAW")=$$GETDAW^PSODAWUT(+PSOX("IRXN"))
 I $G(^%ZOSF("ZVX"))["VX",$T(^VFDPSNDC)]"",$$OPON^VFDPSNDC() D  I 1
 .S $P(^PSRX(PSOX("IRXN"),1,PSOX("NUMBER"),21600),"^",1)=PSOX("SCANNED CODE")
 .;We do not set PSOX("NDC") b/c it was set in GETNDC^PSOREF0 as PSOREF("NDC")
 E  S PSOX("NDC")=$$GETNDC^PSSNDCUT($P(PSOX("RX0"),"^",6))
 ;DSS/SMH/SMP - END MOD
INITX Q
 ;
FILE ;     
