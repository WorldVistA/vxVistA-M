PSOORNE1 ;BIR/SAB - Display new orders from backdoor ;03/06/95 10:30am
 ;;7.0;OUTPATIENT PHARMACY;**11,21,27,32,37,46,71,94,104,117,133,148,279,251,372,313**;DEC 1997;Build 5
...
EDT N FLD,FIELDLST K DIR,DUOUT,DIRUT
 S DIR("A")="Select Field to Edit by number",DIR(0)="LO^1:14"
 I $G(^%ZOSF("ZVX"))["VX",$$VXRX^VFDPSOU1 S DIR(0)="LO^1:15"
 D ^DIR
 I $D(DTOUT)!($D(DUOUT)) K DIR,DIRUT,DTOUT,DTOUT S VALMBCK="" Q
 ;DSS/AMC/SMP - END MOD
...
15 ; Should only be here if vxVistA and field exists
 N DIR,DA S DIR(0)="52,21600.01"
 S DIR("B")=$G(PSONEW("PRESCRIPTION PAD #")) K:DIR("B")="" DIR("B")
 D ^DIR I $D(DUOUT)!$D(DTOUT) S PSODIR("DFLG")=1,VALMBCK="Q" Q
