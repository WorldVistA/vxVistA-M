PSOORRLO ;BHAM ISC/SJA - returns patient's outpatient meds-original sort ;10/12/06
 ;;7.0;OUTPATIENT PHARMACY;**225,331,381**;DEC 1997;Build 15
...
OCL ;entry point to return condensed list
 ...
 .;DSS/SMP - Begin Mods - Add new condtion when to expire, original code in ELSE
 .I $G(^%ZOSF("ZVX"))["VX" D VFD^PSOORRL(7) I 1 ; Reset $T
