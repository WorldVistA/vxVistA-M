PSOLBLD ;BHAM ISC/RTR - PRINTS LABEL ;4/14/93
 ;;7.0;OUTPATIENT PHARMACY;**117,251,387,372**;DEC 1997;Build 18
...
L15 ;DSS/SGM/BG - BEGIN MODS - Conditionally remove pat stat, orig code argument of ELSE
 I $G(VFDPSOLB) W !,?TB3," Clinic: ",PSCLN
 E  W !,?TB3,"Pat. Stat ",PATST," Clinic: ",PSCLN
 ;DSS/SGM/BG - END MODS
L16 W !,@IOF
 I COPIES>0 G START
