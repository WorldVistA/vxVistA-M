PSOLBL ;BIR/SAB/RTR - BOTTLE LABEL ;11/20/08 12:14pm
 ;;7.0;OUTPATIENT PHARMACY;**8,19,30,36,47,71,92,120,157,244,206,225,303,266,326,251,387,379,367**;DEC 1997;Build 18
...
DQ1 D ^PSOLBL4
 ;DSS/BG - BEGIN MODS - set local var to use for OSHERA compliance
 N VFDPSOLB S VFDPSOLB=$T(^VFDPSOLB)'=""
 ;DSS/BG - END MODS
