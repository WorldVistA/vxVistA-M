PSOORCPY ;BIR/SAB-copy orders from backdoor ;10/17/96
 ;;7.0;OUTPATIENT PHARMACY;**10,21,27,32,46,100,117,148,313**;DEC 1997;Build 5
...
COPY ; Rx Copy Functionality 
 ...
 I $G(^%ZOSF("ZVX"))["VX" D  I $G(PSORXED("DFLG")) G OUT
 .I '$D(PSODRUG("DEA")) D
 ..S PSODRUG("DEA")=$P($G(^PSDRUG($P(PSORXED("RX0"),U,6),0)),U,3)
 .Q:'$$VXRX^VFDPSOU1  D
 ..N DIR,DA S DIR(0)="52,21600.01" D ^DIR
 ..I $D(DTOUT)!$D(DUOUT) S PSORXED("DFLG")=1 Q
 ..S PSORXED("PRESCRIPTION PAD #")=Y
 .S:$G(PSORXED("DFLG")) VALMSG="Cannot Copy. Rx Pad # is required on CS RX!"
 ;DSS/AMC/SMP - END MOD
