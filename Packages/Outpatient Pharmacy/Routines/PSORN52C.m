PSORN52C ;BIR/SAB-files renewal entries con't ;08/09/93
 ;;7.0;OUTPATIENT PHARMACY;**1,7,11,27,46,75,87,100,111,124,117,131,146,148,200,225,251,387,379,391**;DEC 1997;Build 18
 ...
 ;DSS/AMC/SMP - BEGIN MOD - File RxPad #
 I $G(^%ZOSF("ZVX"))["VX",$$VFIELD^DILFD(52,21600.01) D
 .Q:$G(PSOX("PRESCRIPTION PAD #"))=""
...
TNT F I=1:1:PSOX("ENT") S ^PSRX(PSOX("IRXN"),6,I,0)=PSOX("DOSE",I)_"^"_$G(PSOX("DOSE ORDERED",I))_"^"_$G(PSOX("UNITS",I))_"^"_$G(PSOX("NOUN",I))_"^" D
 ...
 .Q:'$G(PSOX("SCANNED CODE"))
 .S $P(^PSRX(PSOX("IRXN"),21600),"^",3)=PSOX("SCANNED CODE")
 ;DSS/DLF/SMP - END MOD
 Q
ORC ;
 D MARK^PSOTPCAN
