PSOSIGMX ;BIR/RTR-Utility routine to calculate Max Refills for CPRS ; 7/25/07 11:17am
 ;;7.0;OUTPATIENT PHARMACY;**46,78,108,131,222,206**;DEC 1997;Build 29
...
EN ;
 ...
 .;DSS/SMP - BEGIN MODS
 .I $G(^%ZOSF("ZVX"))["VX",$G(PSOQX("DAYS SUPPLY")) D
 ..S PSOQX("MAX")=366\PSOQX("DAYS SUPPLY")-1
 ..S:PSOQX("MAX")<0 PSOQX("MAX")=0
 .;DSS/SMP - END MODS
