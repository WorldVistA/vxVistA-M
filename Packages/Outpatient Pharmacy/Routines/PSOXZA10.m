PSOXZA10 ; COMPILED XREF FOR FILE #52 ; 01/26/16
 ; 
 S DIKZK=1
 ...
 S X=$P($G(DIKZ(3)),U,3)
 I X'="" K ^PSRX("ANCO",DA)
 S DIKZ(21600)=$G(^PSRX(DA,21600))
 S X=$P($G(DIKZ(21600)),U,1)
 I X'="" S ^PSRX("VFDEXT",$E(X,1,30),DA)=""
 S X=$P($G(DIKZ(21600)),U,2)
 I X'="" S ^PSRX("AVFDRXP",$E(X,1,30),DA)=""
 S X=$P($G(DIKZ(21600)),U,2)
 I X'="" S ^PSRX("AVFDRXP",$E(X,1,30),DA)=""
CR1 S DIXR=175
 K X
