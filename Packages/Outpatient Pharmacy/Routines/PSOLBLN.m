PSOLBLN ;BIR/RTR - NEW PRINTS LABEL ;11/18/92
 ;;7.0;OUTPATIENT PHARMACY;**16,36,71,107,110,117,135,233,251,387,379,367,383,318**;DEC 1997;Build 29
...
L1 ; DSS/SMP - BEGIN MODS to conditionally remove references to VAMC
 I $G(VFDPSOLB) D VAMC^VFDPSOLB("LBLN") I 1
...
L11 W !?54,"Last fill prior to ",$G(EXPDT),?102,"Mfg "_$G(MFG)_" Lot# "_$G(LOT)
 ;DSS/SMP - BEGIN MODS - conditionally suppress copay message
L12 I $G(VFDPSOLB) D COPAY^VFDPSOLB("LBLN") I 1
 ...
 ;DSS/SMP - BEGIN MODS - Conditionally remove patient status
 I $G(VFDPSOLB) D PSTAT^VFDPSOLB("LBLN") I 1
