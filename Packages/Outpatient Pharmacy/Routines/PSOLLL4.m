PSOLLL4 ;BHAM/JLC - LASER LABELS PRINT PMI ;12/13/02
 ;;7.0;OUTPATIENT PHARMACY;**120,135,161,338,367**;DEC 1997;Build 18
 ;
...
CONT S XFONT=$E(PSOFONT,2,99),(CNT,OUT,PMIM)=0
 ...
 ... S LENGTH=0,I=I-1
 ... I HDR D  Q
 .... ; DSS/SMH - BEGIN MODS - VA bug: Next line is supposed to quit at the end (see all similar others)
 .... ; I PSOY>PSOYM S PMIF("A")=J,PMIF("I")=I+1,PMIF("B")=B,OUT=1,PMIM=1 ; b/4
