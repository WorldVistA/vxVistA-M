PSONEW1 ;BIR/DSD - new Rx order entry ;10/17/92
 ;;7.0;OUTPATIENT PHARMACY;**46,104,117,143**;DEC 1997;Build 5
...
32 I '$G(PSONEW("ENT")) W !,"Incomplete Dosaging Data!",! K DIRUT G 31
 ...
 ;
 ;DSS/AMC/SMP BEGIN MODS - If Drug is C2-5; and PAR = ON, ask for RxPad
33 S PSONEW("FLD")=33
 I $G(^%ZOSF("ZVX"))["VX",$$VXRX^VFDPSOU1 D  G:PSONEW("DFLG") END
 .N DIR,DA S DIR(0)="52,21600.01",DIR("B")=$G(PSONEW("PRESCRIPTION PAD #")) K:DIR("B")="" DIR("B") D ^DIR
 .I $D(DUOUT)!($D(DTOUT)) S PSONEW("DFLG")=1 Q
 .S PSONEW("PRESCRIPTION PAD #")=X
