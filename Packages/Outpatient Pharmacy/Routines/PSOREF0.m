PSOREF0 ;IHS/JCM - REFILL CON'T ; 6/17/11 6:02pm
 ;;7.0;OUTPATIENT PHARMACY;**14,152,180,186,204,306,382,388**;DEC 1997;Build 18
...
PROCESS ;
 ...
 ;DSS/DLF/SMH/SMP - BEGIN MOD - NDC Verification/Entry
 I $G(^%ZOSF("ZVX"))["VX" D  G PROCESSX:$G(PSOREF("DFLG"))
 . I $T(^VFDPSNDC)]"",$$OPON^VFDPSNDC() D
 .. S DRG=$P(^PSRX(PSOREF("IRXN"),0),U,6)
 .. S NDC=$P(^PSRX(PSOREF("IRXN"),2),U,7)
 .. D LOOPNDC^VFDPSNDC(DRG,.NDC,1)
 .. I NDC="^" S PSOREF("DFLG")=1 Q
 .. S PSOREF("NDC")=NDC
 .. S PSOREF("SCANNED CODE")=NDC("SCAN")
 ;DSS/DLF/SMH/SMP - END MOD
