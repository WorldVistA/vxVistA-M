PSBOCP ;BIRMINGHAM/TEJ-COVERSHEET PRN OVERVIEW REPORT ;3/19/13 19:13pm
 ;;3.0;BAR CODE MED ADMIN;**32,50,68,70**;Mar 2004;Build 6
...
WRAPPER(X,Y,Z) ;  Text WRAP
 ...
 Q ""
LSTX(P,O) ;
 ;DSS/SMP - BEGIN MOD - Change variable DT to VFDDT - per SACC 2.3.1.5.2
 N VFDDT
 S VFDDT=$$FMDIFF^XLFDT(O,P,2)
 I ((VFDDT\60)<1) Q "0d 0h 1m"
 S D=(VFDDT\(60*60*24)) S VFDDT=VFDDT-(D*(60*60*24))
 S H=(VFDDT\(60*60)) S VFDDT=VFDDT-(H*(60*60))
 S M=((VFDDT+30)\(60)) S VFDDT=VFDDT-(M*(60))
 Q D_"d "_H_"h "_M_"m"
 ;DSS/SMP - END MOD
