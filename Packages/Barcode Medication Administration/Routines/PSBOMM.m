PSBOMM ;BIRMINGHAM/EFC-MISSED MEDS ;9/20/12 2:08pm
 ;;3.0;BAR CODE MED ADMIN;**26,32,56,52,58,70**;Mar 2004;Build 29
...
PRINT ;
 ...
 .......W !,$O(PSBS(DFN,PSBONX,"")),?15,PSBVNI,?22,$G(^DPT(DFN,.101),"**"),?42,$P(^DPT(DFN,0),U)," (",$$ID^VFDDFN(DFN,,,,1,3),")"
 ......E  W !,$O(PSBS(DFN,PSBONX,"")),?15,PSBVNI,?22,$G(^DPT(DFN,.101),"**"),?42,$P(^DPT(DFN,0),U)," (",$E($P(^(0),U,9),6,9),")"
 ......;DSS/SMP - END MODS
 ......S VAR1=$G(^TMP("PSB",$J,DFN,PSBDT,PSBOITX,PSBONX))
 ......S VAR2=$G(^TMP("PSB",$J,DFN,PSBDT,PSBOITX,PSBONX,"X"))
 ......S VAR3=$G(^TMP("PSB",$J,DFN,PSBDT,PSBOITX,PSBONX,.3))
