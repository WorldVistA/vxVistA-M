PSBML ;BIRMINGHAM/EFC-BCMA MED LOG FUNCTIONS ;10/23/12 12:14pm
 ;;3.0;BAR CODE MED ADMIN;**6,3,4,9,11,13,25,45,33,52,70**;Mar 2004;Build 2
...
MEDP D:PSBTRAN="MEDPASS"
 ...
 ...;DSS/SMP - BEGIN MOD
 ...I $G(^%ZOSF("ZVX"))["VX",PSBDD=53.795 D
 ....I $P(PSBREC(PSBCNT),U,6)="" Q
 ....D VAL(PSBDD,PSBIENS,21600.01,$P(PSBREC(PSBCNT),U,6))
 ....D VAL(PSBDD,PSBIENS,21600.02,$$NDC^VFDPSB($P(PSBREC(PSBCNT),U,2),$P(PSBREC(PSBCNT),U,6)))
 ...;DSS/SMP - END MOD
