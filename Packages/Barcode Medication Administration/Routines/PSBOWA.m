PSBOWA ;BIRMINGHAM/EFC-WARD ADMINISTRATION TIMES ;9/29/12 1:57am
 ;;3.0;BAR CODE MED ADMIN;**9,32,56,70**;Mar 2004;Build 18
...
EN ;
 ...
 .....W !,$P(^DPT(DFN,0),U,1),!,"MRN: ",$$ID^VFDDFN(DFN,,,,1,3)
 ....E  W !,$P(^DPT(DFN,0),U,1),!,"SSN: ",$P(^(0),U,9)
 ....;DSS/SMP - END MODS
...
CLNHDR() ;
 ...
 W !,"Patient Name",?64,Y_" Administration Times"
 ;DSS/SMP - BEGIN MODS
 I $G(^%ZOSF("ZVX"))["VX" W !,"MRN",!,"Location",?32
 E  W !,"SSN",!,"Location",?32                       ;[*70-1480]
 ;DSS/SMP - END MODS
 F X=0,.01:.01:.24 W $J($E(X_"00",2,3),4)
 W !,$TR($J("",IOM)," ","-")
 Q ""
