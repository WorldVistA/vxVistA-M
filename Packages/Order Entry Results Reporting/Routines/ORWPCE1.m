ORWPCE1 ;ISL/KCM,JER - PCE Calls from CPRS GUI ;06/12/14  16:13
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,85,116,132,148,187,190,215,243,280,306,361**;Dec 17, 1997;Build 29
 ;
...
DQSAVE ; Background Call to DATA2PCE
 ...
 ;DSS/SMP - BEGIN MODS
 N VFD S VFD=$$VFD I VFD N ROOT3,ORCPTADD,VFDSNO
 S:VFD VFDSNO=0,(ORCPTADD,ORCPTDEL)=""
 ;DSS/SMP - END MODS
 ...
 . . ;DSS/SMP - BEGIN MODS
 . . S:VFD ROOT3="ORPXADD(""PROVIDER"","_PRV_")"
 . . I $E(TYP,4)'="-" D
 . . . S @ROOT@("NAME")=CODE
 . . . S @ROOT@("PRIMARY")=$P(X,U,6)
 . . . S:VFD @ROOT3@("NAME")=CODE
 . . . S:VFD @ROOT3@("PRIMARY")=$P(X,U,6)
 . . . ;DSS/SMP - END MODS
 . . S @ROOT2@("NAME")=CODE
 . . S @ROOT2@("DELETE")=1
 ...
 . . ;DSS/SMP - BEGIN MODS
 . . S:VFD ROOT3="ORPXAPI(""ENCOUNTER"",1)"
 . . I VFD,CODE="PG" S @ROOT@("PROGRAM CODE")=$P(X,U,3) Q
 . . ;DSS/SMP - END MODS
 ...
 . . ;DSS/SMP - BEGIN MODS
 . . S:VFD @ROOT@("PROGRAM CODE")=+$P(X,U,7)
 . . ;DSS/SMP - END MODS
 . . I +$P(X,U,9) D
 ...
 . . ;DSS/SMP - BEGIN MODS
 . . I VFD D
 . . . I $E(TYP,4)'="-" S (ORCPTADD,ORCPTADD(CPT))=CPT
 . . . E  S ORCPTDEL(CPT)=CPT
 . . ;DSS/SMP - END MODS
 ...
 . I VFD,$E(TYP,1,6)="VFDSNO" D  ;SnoMed codes.
 . . Q:'$L(CODE)
