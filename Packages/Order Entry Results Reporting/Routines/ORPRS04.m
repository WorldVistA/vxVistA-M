ORPRS04 ; slc/dcm - Print Order summaries (SHRIVELED) ;11/28/00  15:39
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**11,69,92,121**;Dec 17, 1997;Build 29
EN ;Print orders
...
STS ;
 ...
 ;DSS/TFF/SMP - BEGIN MODS - ADD YEAR TO REPORT
 I $G(^%ZOSF("ZVX"))["VX" D  I 1
 .W:$O(ORTX(0)) $E(ORTX($O(ORTX(0))),1,35)
 .W ?50,ORREQ W:$L(ORSTRT) ?61,$E(ORSTRT,4,5)_"/"_$E(ORSTRT,6,7)_"/"_$E(ORSTRT,2,3)
 .W:$L(ORSTOP) ?71,$E(ORSTOP,4,5)_"/"_$E(ORSTOP,6,7)_"/"_$E(ORSTRT,2,3)
 .W !?3,$$MTIM(ORODT),?13
 .S X=$O(ORTX(0))
 .I X W:$O(ORTX(X)) $E(ORTX($O(ORTX(X))),1,35)
 .W ?50,$E(ORREQ("TIT"),1,10),?64,$$MTIM(ORSTRT),?71,$$MTIM(ORSTOP)
 E  D
