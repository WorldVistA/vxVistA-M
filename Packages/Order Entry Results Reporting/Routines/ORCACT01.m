ORCACT01 ;SLC/MKB-Validate order actions cont ;10/24/13  09:11
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**94,116,134,141,163,187,190,213,243,306,374**;Dec 17, 1997;Build 29
 ;
 ;
ES ; -- sign [on chart]
 ...
 ;DSS/SMP - BEGIN MODS
 N VFD S VFD=$S($G(^%ZOSF("ZVX"))["VX":"Meds/OTC from Elsewhere",1:"non-VA med")
 ;I ACTION="OC",$G(DG)="NV RX" S:MEDPARM<2 ERROR="You are not authorized to release non-VA med orders!" Q
 I ACTION="OC",$G(DG)="NV RX" S:MEDPARM<2 ERROR="You are not authorized to release "_VFD_" orders!" Q
 ;DSS/SMP - END MODS
...
RW ; -- rewrite/copy
 ...
 I DG="NV RX" S ERROR=VFD_" orders cannot be copied!" Q
 ;DSS/SMP - END MODS
