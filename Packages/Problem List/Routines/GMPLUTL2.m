GMPLUTL2 ; ISL/MKB,KER,JER,TC -- PL Utilities (OE/TIU) ;10/04/12  14:10
 ;;2.0;Problem List;**10,18,21,26,35,36,42**;Aug 25, 1994;Build 29
 ;
 ; External References
 ;   DBIA   348  ^DPT(  file #2
...
DETAIL(IFN,GMPL) ; Returns Detailed Data for Problem
 ...
 ;
 ;DSS/SMP  GMPL("VFD RESOLVED") = RESOLVED flag 'R' or EMPTY STRING
 ;
 ...
 ;DSS/SMP - BEGIN MODS - return vxVistA resolved status
 I $G(^%ZOSF("ZVX"))["VX" S GMPL("VFD RESOLVED")=$P($G(^AUPNPROB(IFN,21600)),U,2)
 ;DSS/SMP - END MODS
 Q
 ;
