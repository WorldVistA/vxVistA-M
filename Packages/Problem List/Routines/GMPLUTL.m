GMPLUTL ; SLC/MKB/KER/TC -- PL Utilities ;06/05/14  08:45
 ;;2.0;Problem List;**3,6,8,10,16,26,35,39,36,42**;Aug 25, 1994;Build 29
 ;
 ; External References
 ;   DBIA    348  ^DPT(
...
UPDATE(PL,PLY) ; Update a Problem/Create if Not Found
 ...
 ;DSS/SMP - BEGIN MODS - multiple issues addressed
 ; 1. Variables not NEW'd  2. Some variables not initialized
 ; Original line commented out for reference
 ;S (GMPSC,GMPAGTOR,GMPION,GMPGULF)=0 D:GMPVA VADPT^GMPLX1(GMPDFN)
 N GMPHNC,GMPMST,GMPCV,GMPSHD
 S (GMPSC,GMPAGTOR,GMPION,GMPGULF,GMPHNC,GMPMST,GMPCV,GMPSHD)=0 D:GMPVA VADPT^GMPLX1(GMPDFN)
 ;DSS/SMP - END MODS
 S:'$L($G(PL("DX_DATE_OF_INTEREST"))) PL("DX_DATE_OF_INTEREST")=$$DT^XLFDT
