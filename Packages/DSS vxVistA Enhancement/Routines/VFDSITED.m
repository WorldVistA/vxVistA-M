VFDSITED ;DSS/RBN - ENTER/EDIT OUTPATIENT SITE PARAMETERS ; 09/18/92 9:11
 ;;15.0;DSS,INC VXVISTA OPEN SOURCE;**44**;08 Dec 2015;Build 1
 ;Copyright 1995-2015,Document Storage Systems Inc. All Rights Reserved
 ;
 ; Copied from routine PSOSITE only section that calls the template
 ;  for the purpose of adding vxVistA fileds.
...
1 W ! K DIC S DIC("A")="Select SITE NAME: ",(DIC,DIE)="^PS(59,",DIC(0)="QEALM",DLAYGO=59
 K PSOSITEX D ^DIC G:"^"[X EX K DIC("A") G:Y<0 1 S DA=+Y D FLDQ G:$D(PSOSITEX) EX S DR="[VFD SITE]" W ! D ^DIE
