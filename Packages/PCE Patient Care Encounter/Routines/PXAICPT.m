PXAICPT ;ISL/JVS,ISA/KWP,ESW,SCK - SET THE PROCEDURE(CPT) NODES ;8/10/04 4:39pm
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**19,73,108,112,149,124,164,194**;Aug 12, 1996;Build 29
 ;
 ;
 Q
CPT ;--CREAT PROVIDERS
...
SET ;--SET AND NEW VARIABLES
 ...
 N AFTER0,AFTER1,AFTER12,AFTER801,AFTER802,AFTER811,AFTER812,AFTER21600
 N BEFOR0,BEFOR1,BEFOR12,BEFOR801,BEFOR802,BEFOR811,BEFOR812,BEFOR21600
 ;DSS/RJS/SMP - END MOD
...
SETVARA ;--SET VISIT VARIABLES
 ...
 ;DSS/RJS/SMP - BEGIN MOD
 I $$VX S AFTER21600=$G(PXAA("PROGRAM CODE"))
 ;DSS/RJS/SMP - END MOD
 ;
SETPXKA ;--SET PXK ARRAY AFTER
 ...
 ;DSS/RJS/SMP - BEGIN MOD
 I $$VX S ^TMP("PXK",$J,"CPT",PXAK,21600,"AFTER")=$G(AFTER21600)
 ;DSS/RJS/SMP - BEGIN MOD
 ;
SETVARB ;--SET VARIABLES BEFORE
 ...
 E  D
 .;DSS/RJS/SMP - BEGIN MOD
 .S (BEFOR0,BEFOR12,BEFOR802,BEFOR811,BEFOR812,BEFOR21600)=""
 .;DSS/RJS/SMP - END MOD
 .;
SETPXKB .;--SET PXK ARRAY BEFORE
 ...
 .;DSS/RJS/SMP - BEGIN MOD
 .I $$VX S ^TMP("PXK",$J,"CPT",PXAK,21600,"BEFORE")=$G(BEFOR21600)
 .;DSS/RJS/SMP - END MOD
