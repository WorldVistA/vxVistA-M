PXAICPTV ;ISL/JVS,ISA/KWP,SCK - VALIDATE PROCEDURES(CPT) ;11/14/96  12:46
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**15,73,74,111,121,130,168,194,199**;Aug 12, 1996;Build 29
 ;
...
ARRAY ;--SET ERRORS AND WARNINGS INTO AN ARRAY TO RETURN TO CALLER
 ...
 ;DSS/LM/SMP/BG - Begin Mods
 I $G(^%ZOSF("ZVX"))["VX",PXADI("DIALOG")=216100000.01 D
 .S PXASUB=PXASUB+1
 .S PXAPROB($J,PXASUB,"ERROR","VXSNOMED",PXAK)=$G(PXAERR(12))
 .Q
 ;DSS/LM/SMP/BG - End Mods
 Q
