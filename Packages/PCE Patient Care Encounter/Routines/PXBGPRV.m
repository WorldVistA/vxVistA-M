PXBGPRV ;ISL/JVS,ESW - GATHER PROVIDERS ; 12/5/02 11:35am
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**7,11,108,186**;Aug 12, 1996;Build 13
 ;
...
OCCUP(IEN,DATE,CODE,RETURN,CLASSIEN) ;--FORMAT PERSON CLASS TO DISPLAY
 ...
 ;DSS/SGM - BEGIN MODS - sometimes TYPE is <UNDEFINED>
 I $G(TYPE)<1,$G(^%ZOSF("ZVX"))["VX" Q "-1^PROBLEM ENCOUNTERED, TYPE UNDEFINED"
 ;DSS/SGM - END MODS
