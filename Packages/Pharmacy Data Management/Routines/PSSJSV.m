PSSJSV ;BIR/CML3/WRT-SCHEDULE VALIDATION ;06/24/96
 ;;1.0;PHARMACY DATA MANAGEMENT;**20,38,56,59,110,121,143,149,146**;9/30/97;Build 18
 ;
...
ENFREQ ;validate frequency
 ;DSS/SMP - BEGIN MODS - Expand field 2 in file 51.1 up to 131040 mins
 ;K:+X'=X!(X>129600)!(X<1)!(X?.E1"."1N.N) X
 K:+X'=X!(X>131040)!(X<1)!(X?.E1"."1N.N) X
 ;DSS/SMP - END MODS
 Q
 ;
