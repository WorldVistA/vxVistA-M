PSSDSAPM ;BIR/RTR-Dose Check utilities routine ;09/13/10
 ;;1.0;PHARMACY DATA MANAGEMENT;**117,168,160,173**;9/30/97;Build 29
 ;
 ;
...
PAT ;
 ...
 S PSSDBWT=$P(X,"^",8) I PSSDBWT D
 .I VFD S PSSDBWTX=+$$LB2KG^VFDXLF(PSSDBWT) Q
 .S PSSDBWTX=PSSDBWT/2.2
 S ^TMP($J,PSSDBASE,"IN","DOSE","WT")=$G(PSSDBWTX)
 S DFN=PSSDBDFN
 S GMRVSTR="HT" K X D EN6^GMRVUTL
 S PSSDBHT=$P(X,"^",8) I PSSDBHT D
 .I VFD S PSSDBHTX=+$$IN2M^VFDXLF(PSSDBHT) Q
 .S PSSDBHTX=.0254*PSSDBHT
 ;DSS/SMP - END MODS
