PSSPOIM1 ;BIR/RTR,WRT-Manual create of Orderable Item continued ; 4/28/09 4:36pm
 ;;1.0;PHARMACY DATA MANAGEMENT;**29,38,47,141,153,159,166**;9/30/97;Build 18
 ;
...
SYN I $G(Y)["^"!($G(DIRUT))!$D(DTOUT)!($D(Y)>10) G FINS
 ;DSS/SMP - BEGIN MOD - Ask to copy SYNONYM entries from File 50
 I $G(^%ZOSF("ZVX"))["VX",$T(POSTPOI^VFDPSS)]"",$G(VFDLAYGO) D POSTPOI^VFDPSS
 ;DSS/SMP - END MOD
