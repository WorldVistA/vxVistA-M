PSGLBA ;BIR/CML3-LABEL ALIGNMENT ; 4/24/14 3:26pm
 ;;5.0; INPATIENT MEDICATIONS ;;16 DEC 97;Build 8
 ;
...
ALDONE ;
 ...
 ;
DEV ;
 ;DSS/JG & VEN/SMH - BEGIN MODS - MAR ALIGNMENT LABEL PRINT FOR ZEBRA
 ;I '$D(IO("Q")) F  D ENLP,OK Q:Y
 I '$D(IO("Q")) D
 . N IOP,VFDIOP S VFDIOP=ION
 . F  D ENLP,^%ZISC,OK Q:Y  S IOP=VFDIOP D ^%ZIS
 . S IOP=VFDIOP D ^%ZIS
 ; DSS/JG - VEN/SMH - END MODS
