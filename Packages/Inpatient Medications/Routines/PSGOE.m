PSGOE ;BIR/CML3-PROFILE AND ORDER ENTRY (MAIN DRIVER) ;24 Feb 99 / 10:40 AM
 ;;5.0;INPATIENT MEDICATIONS;**22,29,56,72,95,80,133,181,275**;16 DEC 97;Build 18
 ;
...
EN ;
 ...
 ;
DONE ;
 ;DSS/SMH/SMP - BEGIN MODS
 I $G(^%ZOSF("ZVX"))["VX",$T(^VFDPSNDC)]"",$$IPON^VFDPSNDC
 E  I PSGOP,$P(PSJSYSL,"^",2)]"" D ENQL^PSGLW
...
HK ; Housekeeping (a nice COBOL term)
 ...
 .;DSS/SMH/SMP - BEGIN MOD - Print label ONLY if NDC capture is off
 .I $G(^%ZOSF("ZVX"))["VX",$T(^VFDPSNDC)]"",$$IPON^VFDPSNDC Q
 .;DSS/SMH/SMP - END MOD
