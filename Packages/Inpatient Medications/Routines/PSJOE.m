PSJOE ;BIR/MLM-INPATIENT ORDER ENTRY ;23 Jun 98 / 1:46 PM
 ;;5.0;INPATIENT MEDICATIONS ;**7,26,29,33,42,50,56,72,58,85,95,80,110,111,133,140,151,149,181,252**;16 DEC 97;Build 18
 ;
...
HK ; Housekeeping (a nice COBOL term)
 ...
 .;DSS/SMH/SMP - BEGIN MOD - Print labels ONLY if NDC capture is off
 .I $$VX,$T(^VFDPSNDC)]"",$$IPON^VFDPSNDC() Q
 .;DSS/SMH/SMP - END MOD
