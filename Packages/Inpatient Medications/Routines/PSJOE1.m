PSJOE1 ;BIR/CML3-UD OE FOR COMBINED OE ;29 JAN 99 / 9:44 AM
 ;;5.0;INPATIENT MEDICATIONS ;**2,7,25,30,47,56,64,179,181,252**;16 DEC 97;Build 18
 ;
...
AD ; Ask Drug
 ...
 I $G(^%ZOSF("ZVX"))["VX" D
 . I '$G(PSGDRG) S PSGDRG=$O(^PSDRUG("ASP",PSGPDRG,0)) I PSGDRG,'$O(^(PSGDRG)) Q
 . I $T(^VFDVXFCL)]"" D
 .. S ANQX=0 D CLOZ^VFDVXFCL(PSGP,PSGDRG) G AD:ANQX S PSJPROT=1
 ;DSS/RBN/SMP - END MOD
