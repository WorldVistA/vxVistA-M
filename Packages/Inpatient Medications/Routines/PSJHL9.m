PSJHL9 ;BIR/LDT-VALIDATE INCOMING HL7 DATA/CREATE NEW ORDER ; 2/14/12 7:14am
 ;;5.0;INPATIENT MEDICATIONS;**1,18,31,42,47,50,63,72,75,58,80,110,111,134,267,279**;16 DEC 97;Build 1
 ;
...
NVO ; put new orders in non-verified orders file
 ...
 I $G(^%ZOSF("ZVX"))["VX" D
 .I '$D(^PS(55,PSJHLDFN,0)) D
 ..N DO,DA,DD,DIC,PSIVFN,DIK
 ..S ^PS(55,PSJHLDFN,0)=PSJHLDFN,DIK="^PS(55,",DIK(1)=.01,DA=PSJHLDFN D EN^DIK
 ..I $D(XQSAV) D
