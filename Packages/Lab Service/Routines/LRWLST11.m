LRWLST11 ;DALOI/STAFF - ACCESSION SETUP ;Mar 27, 2008
 ;;5.2;LAB SERVICE;**121,128,153,202,286,331,375,350,440**;Sep 27, 1994;Build 29
 ;
ST21 ;
 S LRTS="",LRIX=0
...
SLRSS ;
 ...
 ;
 ;DSS/FHS - BEGIN MOD - Set Collection by Person if available
 ;
 ;VFDCDUZ set in routine LROE
 I $G(^%ZOSF("ZVX"))["VX",$G(VFDCDUZ) D
 . S $P(^LR(LRDFN,LRSS,LRIDT,"VFD"),U,2)=+$G(VFDCDUZ)
