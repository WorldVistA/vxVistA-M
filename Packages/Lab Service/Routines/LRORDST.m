LRORDST ;SLC/CJS/WTY - SET THE ORDER AND ACCESSION ; 2/9/12 3:15pm
 ;;5.2;LAB SERVICE;**100,107,121,153,202,290,291,359,362**;Sep 27, 1994;Build 2
...
ZX K:$G(LRORDR)'="P" LRCOM,LRTCOM
 ...
 ;DSS/FHS - BEGIN MOD - Added Lock time out to call
 ;L +^LRO(69,LRODT,1)
 I $G(^%ZOSF("ZVX"))["VX" D
 . L +^LRO(69,LRODT,1):DILOCKTM
 E  L +^LRO(69,LRODT,1)
 ;DSS/FHS - END MOD
...
ZSN N I
 ...
 . ;DSS/FHS -  BEGIN MOD -Insert the line below to store the DUZ of collector
 . I $G(^%ZOSF("ZVX"))["VX" D
 . . S $P(^LRO(69,LRODT,1,LRSN,1),"^",3)=$G(DUZ)
 . ;DSS/FHS - END MOD
