GMRVSC0 ;HIOFO/MD,YH,FT-CUMULATIVE VITALS/MEASUREMENTS FOR PATIENT OVER GIVEN DATE RANGE ;9/27/07
 ;;5.0;GEN. MED. REC. - VITALS;**23**;Oct 31, 2002;Build 1
 ;
...
FOOTER ;REPORT FOOTER SUBROUTINE
 ;DSS/SMP - BEGIN MODS
 I $G(^%ZOSF("ZVX"))["VX" D
 .W !!,"*** (E) - Error entry",!! W:VADM(1)'="" ?$X-3,$E(VADM(1),1,15) W:$G(VA("MRN"))'="" ?17,VA("MRN") W:VADM(3)'="" ?30,$P(VADM(3),"^",2) W:VADM(4)'="" ?43,$P(VADM(4),"^")_" YRS"
 E  D
 ...
 W:$G(^%ZOSF("ZVX"))'["VX" ?65,"VAF 10-7987j"
 W !,"Unit: "_$S($P(VAIN(4),"^",2)'="":$P(VAIN(4),"^",2),1:"     "),?32,"Room: "_$S($P(VAIN(5),"^")'="":$P(VAIN(5),"^"),1:"   "),!
 ;DSS/SMP - END MODS
