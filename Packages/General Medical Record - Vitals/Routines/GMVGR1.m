GMVGR1 ;HIOFO/YH,FT-SET ^TMP($J) GLOBAL ;11/29/02  13:34
 ;;5.0;GEN. MED. REC. - VITALS;**1**;Oct 31, 2002;Build 8
 ;
...
SETA ;Store measurements in ^TMP($J,"GMRK" global
 ...
 I GI="H" D  Q
 . I VFD D  Q
 . . S ^TMP($J,"GMRK","G"_(270+GCNTD))=GK_" "_GMRSITE,^TMP($J,"GMRK","G"_(290+GCNTD))=$S(GK>0:$$IN2CM^VFDXLF(GK,2),1:"") S:GK>0 GMRHT=$$IN2M^VFDXLF(GK)
 ...
 . I GI="CG" D
 . . I VFD D  Q
 . . . S ^TMP($J,"GMRK","G"_(1250+GCNTD))=GK_" "_GMRSITE,^TMP($J,"GMRK","G"_(1320+GCNTD))=$S(GK>0:$$IN2CM^VFDXLF(GK,2),1:"")
 ...
 . I VFD D  I 1
 . . S ^TMP($J,"GMRK","G"_(GJ*16+GCNTD+1))=GK_$S(GMRVJ=1&(GI'="C"):"*",1:" ")_$S(GI="B":"",1:GMRSITE) S:GI="W" ^TMP($J,"GMRK","G"_(310+GCNTD))=$S(GK>0:$$LB2KG^VFDXLF(GK,2),1:"")
