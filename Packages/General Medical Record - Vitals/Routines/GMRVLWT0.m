...
EN1 ;
 ...
 .I $G(GWT)>0 S GWT=GWT\10*10+30,J=0 F I=1:1:8 S GWT(I)=GWT-(10*J),J=J+1,GWT(I)=GWT(I)_"/"_$$LB2KG^VFDXLF(GWT(I),2)
 E  I $G(GWT)>0 S GWT=GWT\10*10+30,J=0 F I=1:1:8 S GWT(I)=GWT-(10*J),J=J+1,GWT(I)=GWT(I)_"/"_$J(GWT(I)/2.2,0,2)
 ;DSS/SMP - END MODS
 E  S GWT=""
 U IO D ^GMRVLWT1
