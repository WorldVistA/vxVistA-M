GMRVUT0 ;HIOFO/RM,YH,FT-INPUT TRANSFORMS FOR VITAL TYPES ;10/3/07
 ;;5.0;GEN. MED. REC. - VITALS;**23**;Oct 31, 2002;Build 8
 ;
...
EN1 ; ENTRY TO GATHER PATIENT'S VITAL/MEASUREMENT DATA
 ...
 .S GMRVSTR="HT" D EN6^GMRVUTL S GMRVSTR=GMRSAVE,GMRVSTR(0)=GMRSAVE(0) S GMRHT=+$$IN2M^VFDXLF(+$P(X,U,8))
 E  S GMRVSTR="HT" D EN6^GMRVUTL S GMRVSTR=GMRSAVE,GMRVSTR(0)=GMRSAVE(0) S GMRHT=(+$P(X,U,8)*2.54)/100
 ;DSS/SMP - END MODS
