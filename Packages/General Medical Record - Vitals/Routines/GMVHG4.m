...
SETA ;
 ...
 I GI="H" D  Q
 . I VFD D  Q
 . . S ^TMP($J,"GMRK","G"_(470+GCNTD))=GK_" "_GMRSITE,^TMP($J,"GMRK","G"_(1100+GCNTD))=$S(GK>0:$$IN2CM^VFDXLF(GK,2),1:"") S:GK>0 GMRHT=$$IN2M^VFDXLF(GK)
 . S ^TMP($J,"GMRK","G"_(470+GCNTD))=GK_" "_GMRSITE,^TMP($J,"GMRK","G"_(1100+GCNTD))=$S(GK>0:$J(GK*2.54,0,2),1:"") S:GK>0 GMRHT=GK*2.54/100 Q
 ...
 . I GI="CG" D
 . . I VFD D  Q
 . . . S ^TMP($J,"GMRK","G"_(1550+GCNTD))=GK_GMRSITE,^TMP($J,"GMRK","G"_(1620+GCNTD))=$S(GK>0:$$IN2CM^VFDXLF(GK,2),1:"")
 ...
 I '(GI="T"!(GI="P")) D  Q
 . I VFD D  I 1
 . . S ^TMP($J,"GMRK","G"_(GJ*16+GCNTD+1))=GK_$S(GMRVJ=1:"*",1:"")_$S(GI="B":"",1:GMRSITE) S:GI="W" ^TMP($J,"GMRK","G"_(1200+GCNTD))=$S(GK>0:$$LB2KG^VFDXLF(GK,2),1:"")
 . E  S ^TMP($J,"GMRK","G"_(GJ*16+GCNTD+1))=GK_$S(GMRVJ=1:"*",1:"")_$S(GI="B":"",1:GMRSITE) S:GI="W" ^TMP($J,"GMRK","G"_(1200+GCNTD))=$S(GK>0:$J(GK/2.2,0,2),1:"")
 . ;DSS/SMP - END MODS
 . I GI="W",GK>0 D
