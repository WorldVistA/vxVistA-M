GMRVHW0 ;HIRMFO/YH-HP LASER WEIGHT CHART - DATA ARRAY ;5/14/97
 ;;4.0;Vitals/Measurements;**1**;Apr 25, 1997;Build 8
EN1 ;
 ...
 .I GWT>0 S GWT=GWT\10*10-40,J=0 F I=1:1:8 S GWT(I)=GWT+(10*J),J=J+1,GWT(I)=GWT(I)_"/"_$$LB2KG^VFDXLF(GWT(I),2)
 E  I GWT>0 S GWT=GWT\10*10-40,J=0 F I=1:1:8 S GWT(I)=GWT+(10*J),J=J+1,GWT(I)=GWT(I)_"/"_$J(GWT(I)/2.2,0,2)
 ;DSS/SMP - END MODS
 U IO D GRAPH
...
SETA ;
 ...
 I GI="H" D  Q
 .I VFD S ^TMP($J,"GMRK","G"_(300+GCNTD))=GK,^("G"_(340+GCNTD))=GMRSITE,^TMP($J,"GMRK","G"_(320+GCNTD))=$S(GK>0:$$IN2CM^VFDXLF(GK,2),1:"") S:GK>0 GMRHT=$$IN2M^VFDXLF(GK) Q
 .S ^TMP($J,"GMRK","G"_(300+GCNTD))=GK,^("G"_(340+GCNTD))=GMRSITE,^TMP($J,"GMRK","G"_(320+GCNTD))=$S(GK>0:$J(GK*2.54,0,2),1:"") S:GK>0 GMRHT=GK*2.54/100 Q
 ...
 I VFD S ^TMP($J,"GMRK","G"_(100+GCNTD))=GK,^TMP($J,"GMRK","G"_(120+GCNTD))=$S(GK>0:$$LB2KG^VFDXLF(GK,2),1:"") I 1
 E  S ^TMP($J,"GMRK","G"_(100+GCNTD))=GK,^TMP($J,"GMRK","G"_(120+GCNTD))=$S(GK>0:$J(GK/2.2,0,2),1:"")
 ;DSS/SMP - END MODS
