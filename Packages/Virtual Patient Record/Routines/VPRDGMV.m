VPRDGMV ;SLC/MKB -- Vitals extract ;8/2/11  15:29
 ;;1.0;VIRTUAL PATIENT RECORD;**1**;Sep 01, 2011;Build 8
...
EN1(ID,VIT) ; -- return a vital/measurement in VIT("attribute")
 ...
 I TYPE="HT" D
 .I VFD S MUNT="cm",MRES=$$IN2CM^VFDXLF(X,2) Q
 .S MUNT="cm",MRES=$J(2.54*X,0,2)  ;EN2^GMRVUTL
 I TYPE="WT" D
 .I VFD S MUNT="kg",MRES=$$LB2KG^VFDXLF(X,2) Q
 .S MUNT="kg",MRES=$J(X/2.2,0,2)   ;EN3^GMRVUTL
 I TYPE="CG" D
 .I VFD S MUNT="cm",MRES=$$IN2CM^VFDXLF(X,2) Q
 .S MUNT="cm",MRES=$J(2.54*X,0,2)
 ;DSS/SMP - END MODS
