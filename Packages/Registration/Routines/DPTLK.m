DPTLK ;ALB/RMO,RTK - MAS Patient Look-up Main Routine ; 3/22/05 4:19pm
 ;;5.3;Registration;**32,72,93,73,136,157,197,232,265,277,223,327,244,513,528,541,576,600,485,633,629,647,769,857,876**;Aug 13, 1993;Build 29
 ;
...
ENR ;Display Enrollment information after patient selection
 ;DSS/SMP - BEGIN MODS - Do not display enroll data
 I $G(^%ZOSF("ZVX"))["VX" Q
 ;DSS/SMP - END MODS
