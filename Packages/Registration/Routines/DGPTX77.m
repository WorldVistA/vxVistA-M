...
X1(DION) K X
 ...
 S X=$G(X(1))
 Q
2 N X,X1,X2 S DIXR=1147 D X2(U) K X2 M X2=X D X2("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X2(DION) K X
 ...
 S X=$G(X(1))
 Q
3 N X,X1,X2 S DIXR=1148 D X3(U) K X2 M X2=X D X3("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X3(DION) K X
 ...
 S X=$G(X(1))
 Q
4 N X,X1,X2 S DIXR=1149 D X4(U) K X2 M X2=X D X4("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X4(DION) K X
 ...
 S X=$G(X(1))
 Q
5 N X,X1,X2 S DIXR=1150 D X5(U) K X2 M X2=X D X5("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X5(DION) K X
 ...
 S X=$G(X(1))
 Q
6 N X,X1,X2 S DIXR=1151 D X6(U) K X2 M X2=X D X6("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X6(DION) K X
 ...
 S X=$G(X(1))
 Q
7 N X,X1,X2 S DIXR=1152 D X7(U) K X2 M X2=X D X7("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X7(DION) K X
 ...
 S X=$G(X(1))
 Q
8 N X,X1,X2 S DIXR=1153 D X8(U) K X2 M X2=X D X8("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X8(DION) K X
 ...
 S X=$G(X(1))
 Q
9 N X,X1,X2 S DIXR=1154 D X9(U) K X2 M X2=X D X9("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X9(DION) K X
 ...
 S X=$G(X(1))
 Q
10 N X,X1,X2 S DIXR=1155 D X10(U) K X2 M X2=X D X10("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X10(DION) K X
 ...
 S X=$G(X(1))
 Q
11 N X,X1,X2 S DIXR=1156 D X11(U) K X2 M X2=X D X11("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X11(DION) K X
 ...
 S X=$G(X(1))
 Q
12 N X,X1,X2 S DIXR=1157 D X12(U) K X2 M X2=X D X12("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
...
X12(DION) K X
 ...
 S X=$G(X(1))
 Q
13 N X,X1,X2 S DIXR=1158 D X13(U) K X2 M X2=X D X13("F") K X1 M X1=X
 I $G(X(1))]"",$G(X(2))]"",$G(X(3))]"",$G(X(4))]"" D
