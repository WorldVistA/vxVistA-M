DGPTXC ; GENERATED FROM 'DG PTF CREATE PTF ENTRY' INPUT TEMPLATE(#443), FILE 45;01/07/16
 D DE G BEGIN
...
C1F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1145,1146,1147,1148,1149,1150,1151,1152,1153,1154,1155,1156,1157,1158,1159 S DIEZRXR(45,DIXR)=""
 Q
X1 Q
