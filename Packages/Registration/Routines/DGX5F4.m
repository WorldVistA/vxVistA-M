DGX5F4 ; ;01/08/16
 ;;
1 N X,X1,X2 S DIXR=1160 D X1(U) K X2 M X2=X D X1("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X1(DION) K X
 ...
 S X=$G(X(1))
 Q
2 N X,X1,X2 S DIXR=1161 D X2(U) K X2 M X2=X D X2("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X2(DION) K X
 ...
 S X=$G(X(1))
 Q
3 N X,X1,X2 S DIXR=1162 D X3(U) K X2 M X2=X D X3("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X3(DION) K X
 ...
 S X=$G(X(1))
 Q
4 N X,X1,X2 S DIXR=1163 D X4(U) K X2 M X2=X D X4("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X4(DION) K X
 ...
 S X=$G(X(1))
 Q
5 N X,X1,X2 S DIXR=1164 D X5(U) K X2 M X2=X D X5("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X5(DION) K X
 ...
 S X=$G(X(1))
 Q
6 N X,X1,X2 S DIXR=1165 D X6(U) K X2 M X2=X D X6("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X6(DION) K X
 ...
 S X=$G(X(1))
 Q
7 N X,X1,X2 S DIXR=1166 D X7(U) K X2 M X2=X D X7("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X7(DION) K X
 ...
 S X=$G(X(1))
 Q
8 N X,X1,X2 S DIXR=1167 D X8(U) K X2 M X2=X D X8("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X8(DION) K X
 ...
 S X=$G(X(1))
 Q
9 N X,X1,X2 S DIXR=1168 D X9(U) K X2 M X2=X D X9("F") K X1 M X1=X
 I $G(X(2))]"" D
...
X9(DION) K X
 ...
 S X=$G(X(1))
 Q
10 N X,X1,X2 S DIXR=1169 D X10(U) K X2 M X2=X D X10("F") K X1 M X1=X
 I $G(X(2))]"" D
