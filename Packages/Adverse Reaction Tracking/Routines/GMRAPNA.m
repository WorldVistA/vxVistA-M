GMRAPNA ;HIRMFO/WAA-PATIENT NOT ASKED ABOUT ALLERGIES ;12/1/95  14:15
 ;;4.0;Adverse Reaction Tracking;**30,33**;Mar 29, 1996;Build 1
...
HEAD ;HEADER PAGE FOR PRINTOUT
 ...
 ;DSS/RAC - BEGIN MODS - Deveteranize Header (S16424) - Original code in else statement
 I ^%ZOSF("ZVX")["VX" W !!,"PATIENT",?30,"MRN" W:GMRA'="C" ?45,"PROVIDER"
 E  W !!,"PATIENT",?30,"SSN" W:GMRA'="C" ?45,"PROVIDER"
 ;DSS/RAC - END MODS
 W !,$$REPEAT^XLFSTR("-",78)
