XINDX10 ;ISC/GRK - assemble DD executable code ;11/12/2002  11:40
 ;;7.3;TOOLKIT;**20,27,66,68,132**;Apr 25, 1995;Build 6
...
ASK ;Ask for Build, Install, or Package file.
 ...
 . ;DSS/TFF - BEGIN MODS - Version Check
  . I $G(^%ZOSF("ZVX"))["VX",$E(X,1,3)="VFD" D
  . . S INP(11)="I $E(RTN,1,3)=""VFD"",$P(LIN,"";"",3)'["""_V_""" D E^XINDX1(44)"
  . E  S INP(11)="I $P(LIN,"";"",3)'["""_V_""" D E^XINDX1(44)",INP(11.1)=V
  . ;DSS/TFF - END MODS
