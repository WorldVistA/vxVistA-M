XINDEX ;ISC/REL,GFT,GRK,RWF - INDEX & CROSS-REFERENCE ;08/04/08  13:19
 ;;7.3;TOOLKIT;**20,27,48,61,66,68,110,121,128,132,133**;Apr 25, 1995;Build 6
...
BEG ;
 ...
 . ;DSS/SGM - BEGIN MODS - allow for 4 digit version number
 . ; original VA line now argument of "E  I" line
 . I $G(^%ZOSF("ZVX"))["VX" D:$$VALID^VFDI0000($P(LIN,";",3))<1 E^XINDX1(44) I 1
 . E  I $P(LIN,";",3,99)'?1.2N1"."1.2N.1(1"T",1"V").2N1";"1A.APN1";".E D E^XINDX1(44) ;patch 132
 . ;DSS/SGM - END MODS
