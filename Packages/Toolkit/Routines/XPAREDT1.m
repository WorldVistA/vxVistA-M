XPAREDT1 ; SLC/KCM - Supporting Calls - Entities; [3/31/03 7:19am] ;9/12/07  16:19
 ;;7.3;TOOLKIT;**26,109**;Apr 25, 1995;Build 1
 ;
BLDLST ; ...continued from BLDLST^XPAREDIT(LST,PAR)
 ...
 . ;DSS/SGM - BEGIN MODS - vxVistA allows another security
 . ; IA# 10076 - Read of ^XUSEC(), orig VA code now starts with E  I FN
 . S FN=$P(^XTV(8989.51,+PAR,30,IEN,0),"^",2)
 . I $G(^%ZOSF("ZVX"))["VX" D  Q:'$D(FN)
 . . Q:FN'=9.4  Q:DUZ(0)["@"  Q:$D(^XUSEC("VFD XPAR PACKAGE EDIT",DUZ))
 . . K FN Q
 . E  I FN=9.4,(DUZ(0)'["@") Q
 . ;DSS/SGM - END MODS
